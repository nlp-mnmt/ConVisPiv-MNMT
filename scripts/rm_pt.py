...
def main():
    parser = argparse.ArgumentParser(
        description=(
            ...
            'but preserve checkpoint_last.pt and checkpoint_last.pt'
        )
    )
    ...
    parser.add_argument('--delete-best', action='store_true', help='delete checkpoint_last.pt')
            ...
            for file in files:
                ...
                if (
                    ...
                    and (
                        ...
                        or (file == 'checkpoint_last.pt' and not args.delete_best)
                        or file in to_save
                    )
                ):
